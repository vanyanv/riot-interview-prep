 ...
 * result[j] = [IDj, topFiveAveragej] represents the student with IDj and
 ...
 *       truncated to 88 by integer division.
 *
 * Example 2:
 ...
 *
 * Approach:
 *   - Group scores by student ID using a hash map.
 *   - For each student, sort scores in descending order.
 *   - Take the top 5 scores, sum them, and divide by 5 (integer division).
 *   - Sort results by ID and return.
 */
