 ...
 *     of returning.
 *
 * Use reservoir sampling to solve this problem efficiently.
 *
 * Example 1:
 *   Input:
 ...
 *   - Iterate through nums. For every occurrence of target, increment a count.
 *   - With probability 1/count, replace the chosen index with the current index.
 *   - This guarantees each valid index is chosen with equal probability.
 */
...
class Solution {
  ...
  pick(target: number): number {
    // TODO: implement using reservoir sampling
    return -1;
  }
}
